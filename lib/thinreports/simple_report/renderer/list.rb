  ...
  module SimpleReport
    module Renderer
      class List < Base
        ...
        def render(list_page)
          render_section(list_page.header) if list_page.header
          ...
          manager.format.shapes.each do |id, shape|
            ...
            @pdf.draw_shape_pageno(shape.internal, list_page.no, list_page.manager.page_count)
          end
        end
        ...
        def render_section(section)
          ...
          list_section_renderer(internal).render(section, position)
        end
