    ...
    module Report
      class Base
        ...
        class << self
          ...
          # @yield [report]
          # @yieldparam [Thinreports::SimpleReport::Report::Base] report
        ...
        # @return [Thinreports::SimpleReport::Report::Internal]
        attr_reader :internal

        # @return [Integer]
        attr_reader :start_page_number

        # @return [Thinreports::SimpleReport::Report::Page]
        ...
        # @yield [page]
        # @yieldparam [Thinreports::SimpleReport::Report::Page] page
        # @example
        ...
        # @param [Hash] options
        # @option options [Boolean] :count (true)
        # @return [Thinreports::SimpleReport::Report::BlankPage]
